...
@Component("scheduleTccCancelService")  
@RequestMapping("/schedule/tcc/cancel")  
public class ScheduleTccCancelService implements ScheduleTccApi {
	...
	public Boolean informSubmitOrderEvent(OrderInfoDTO order) throws Exception {
		for(OrderItemDTO orderItem : order.getOrderItems()) {
			...
			stockUpdater.setTccType(TccType.CANCEL);  
			stockUpdater.update(); 
		}
