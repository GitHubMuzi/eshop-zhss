...
@Component("inventoryTccCancelService")
@RequestMapping("/inventory/tcc/cancel")  
public class InventoryTccCancelService implements InventoryTCCApi {
	...
	public Boolean informSubmitOrderEvent(OrderInfoDTO orderDTO) {
		...
		goodsStockUpdateCommand.setTccType(TccType.CANCEL);  
